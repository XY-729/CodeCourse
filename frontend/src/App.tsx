...
import { AlertCircle, BookOpen, BrainCircuit, Download, FileArchive, FolderTree, Loader2, PanelLeft, Pencil, Plus, RefreshCw, Save, Search, Sparkles, Star, X } from "lucide-react";
import {
  buildProjectIndex,
        ...
        <MobileWorkspaceSheet
          ...
          feedback={error || mobileWorkspaceBusy || toast ? (
            <TaskFeedback
              ...
              label={dataTransferBusy ? taskMessage : mobileWorkspaceTab !== "assistant" && qaInteractionBusy ? qaBusyLabel : loading ? "正在处理" : activeTask ? taskStatusMessage(activeTask) : taskMessage}
              progressCurrent={activeTask?.progress_current}
              progressTotal={activeTask?.progress_total}
              toast={toast}
              onDismissError={() => setError("")}
